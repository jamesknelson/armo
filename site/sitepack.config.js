...
function highlight(code, specifiedLanguage) {
  if (specifiedLanguage) {
    const language = codeBlockAliases[specifiedLanguage] || specifiedLanguage
    if (language) {
...
export default ({ environment }) => ({
  ...
  rules: [
    ...
    /**
     * This loader allows us to use a standard React component as a page's
     * content
     */
    { test: /\.component\.js$/,
      exclude: /node_modules/,
      use: [
        'sitepack-component-page',
        'babel',
      ]
    },

    /**
     * This loader includes raw JavaScript.
     */
    { test: /\.example\.js$/,
      exclude: /node_modules/,
      use: [
        'sitepack-component-page',
        //'sitepack-example-page',
      ]
    },
  ...
  paths: {
    ...
    /**
     * A list of directories other than node_modules where sitepack should
     * search for modules
     */
    modules: [
      '../src',
